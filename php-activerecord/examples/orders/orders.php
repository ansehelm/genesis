...
ActiveRecord\Config::initialize(function($cfg)
{
    ...
    $cfg->set_connections(array('development' => 'mysql://chris:chris@localhost/orders_test'));
...
if (count($freebie->errors) > 0)
	echo "[FAILED] saving order $freebie->item_name: " . join(', ',$freebie->errors->full_messages()) . "<br><br>";
